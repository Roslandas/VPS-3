										...
										then
											...
											then
												...
												then
													...
													[ $? -eq 0 ] && tput setaf 2 ; tput bold ; echo ""; echo "Vartotojo vardas $username creado" ; echo "Galiojimo laikas: $gui" ; echo "Nº leidziama vienu metu jungtis: $sshlimiter" ; echo "" || echo "Negaliu sukurti vartotojo!" ; tput sgr0
